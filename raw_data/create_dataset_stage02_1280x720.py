...
def process_image(args):
    ...
    img_resized = img
    # img_resized = cv2.resize(img, (1280,720), interpolation=cv2.INTER_NEAREST)
...
if __name__ == '__main__':
    ...
    for level_grp in level_grps:
        ...
        ppl_bgr = eval(obj_id_to_rgb[str(249)])
        cars_bgr = eval(obj_id_to_rgb[str(250)])

        out_dir_base = "./created_dataset_stage02_1280x720"
        ...
        obj2rgb = {}
        obj2rgb["People"] = (ppl_bgr[2],ppl_bgr[1],ppl_bgr[0])
        obj2rgb["Car"] = (cars_bgr[2],cars_bgr[1],cars_bgr[0])
